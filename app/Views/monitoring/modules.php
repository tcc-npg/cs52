            ...
            <form class="modal-content" method="POST" action="<?= url_to('monitoring.addModule'); ?>">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" min='0' class="form-control" id="amount" placeholder="Enter amount" value=""
                            name="amount">
                    </div>
                </div>
        ...
        <div class="row g-4">
            ...
            <?php foreach ($list as $module): ?>
                ...
                <div class="col-md-4 p-1">
                    <a href="<?php echo url_to('monitoring.studentsList', $module['module_id'], $module['name'], $module['amount']) ?>">
                        <div
